    ...
    <section
      ...
      <div className="text-center mb-16">
        ...
        <p className="text-gray-400 mt-4 text-lg font-semibold">
         My education has been a journey of learninf and development. Here are the deatails of my academics background
        </p>
      </div>
          ...
          >
            ...
            <div
              className={`w-full sm:max-w-md p-4 sm:p-8 rounded-2xl  border border-white bg-gray-900 backdrop-blur-md shadow-[0_0_20px_1px_rgba(130,69,236,0.3)] ${index % 2 === 0 ? "sm:ml-0" : "sm:mr-0"
                } sm:ml-44 sm:mr-0 ml-8 transform transition-transform duration-300 hover:scale-105`}
            >
